...
public final class Parameters {
	...
	public static final int parkingSize = 1000;
	...
	public static final double minFuel = 10000*60; //tempo in millisecondi nell'esecuzione, in timeUnit nella simulazione
	public static final double maxFuel = 20000*60; //tempo in millisecondi nell'esecuzione, in timeUnit nella simulazione
	...
	public static final boolean logAnalysis = false;
